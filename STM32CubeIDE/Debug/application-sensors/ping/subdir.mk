...
C_DEPS += \
./application-sensors/ping/ping.d 


# Each subdirectory must supply rules for building sources it contributes
application-sensors/ping/ping.o: C:/Users/rozzie/dev/sparrow-accelerator-sensor-firmware/user-defined-sensors/ping/ping.c application-sensors/ping/subdir.mk
...
clean: clean-application-2d-sensors-2f-ping

clean-application-2d-sensors-2f-ping:
	-$(RM) ./application-sensors/ping/ping.d ./application-sensors/ping/ping.o

.PHONY: clean-application-2d-sensors-2f-ping
