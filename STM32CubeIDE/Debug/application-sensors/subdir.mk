...
C_DEPS += \
./application-sensors/init.d 


# Each subdirectory must supply rules for building sources it contributes
application-sensors/init.o: C:/Users/rozzie/dev/sparrow-accelerator-sensor-firmware/user-defined-sensors/init.c application-sensors/subdir.mk
...
clean: clean-application-2d-sensors

clean-application-2d-sensors:
	-$(RM) ./application-sensors/init.d ./application-sensors/init.o

.PHONY: clean-application-2d-sensors
